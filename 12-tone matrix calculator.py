...
scale = {'c': 6000, 'cis': 6100, 'des': 6100, 'd': 6200, 'dis': 6300, 'es': 6300,
         'e': 6400, 'f': 6500, 'fis': 6600, 'ges': 6600, 'g': 6700,
         'gis': 6800, 'as': 6800, 'a': 6900, 'ais': 7000, 'b': 7000, 'h': 7100}
keys = scale.keys()
...
for x in prima:
    if prima.count(x) > 1:
        ans1 = input('Your list has duplicates. Do you want to continue? (y/n)')
        if ans1 == 'y':
            print('OK')
        else:
            exit(0)
...
ans2 = input('Matrix has been calculated. Do you want to save P-form in mc? (y/n)')
if ans2 == 'y':
